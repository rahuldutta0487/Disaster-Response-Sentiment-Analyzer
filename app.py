...
# Page configuration
st.set_page_config(
    page_title="Disaster Response Sentiment Analysis",
    page_icon="🌊",
    layout="wide",
...
st.markdown("Real-time Twitter sentiment analysis for monitoring disaster-related trends and public response")
...
with st.sidebar:
    ...
    disaster_types = ["All", "Hurricane", "Earthquake", "Flood", "Wildfire", "Tornado", "Tsunami"]
...
if df.empty:
    ...
    tab1, tab2, tab3, tab4, tab5 = st.tabs(["Sentiment Analysis", "Tweet Volume", "Word Cloud", "Location Map", "Database Management"])
...
st.markdown(
    ...
    <div style="text-align: center">
        <p>Developed for disaster response monitoring and analysis. Data refreshes every {refresh_rate} seconds.</p>
    </div>
